...
export type LocaleMessages = {
  ...
  qrModeUrl: string;
  qrModeText: string;
  qrModeContact: string;
  qrModeWifi: string;
  qrInputLabel: string;
  qrUrlPlaceholder: string;
  qrTextPlaceholder: string;
  qrContactName: string;
  qrContactPhone: string;
  qrContactEmail: string;
  qrWifiSsid: string;
  qrWifiPassword: string;
  qrWifiEncryption: string;
  qrWifiNone: string;
  qrGenerateAction: string;
  qrCopyPayload: string;
  qrCopied: string;
  qrReset: string;
  qrForeground: string;
  qrBackground: string;
  ...
  qrEmptyPreview: string;
  qrEmptyValue: string;
  qrGenerateError: string;
